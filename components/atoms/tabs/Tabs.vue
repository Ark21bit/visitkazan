<template>
    <div>
        <div class="flex lt-[1340px]:flex-col">
            <ul class='tabs-header text-sm font-medium text-fblack px-2.5 py-2 flex lt-sm:flex-col lg:gap-2 justify-between rounded-1.25 shadow-[0_4px_23px_0)] shadow-black/7'>
