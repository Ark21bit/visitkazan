...
const colorClasses = {
    ...
    outline: {
        default: {
            white: 'bg-transparent text-fblack disabled:bg-inactive ring-1 ring-inset ring-fline disabled:ring-inactive disabled:text-inactive',
        },
        hover: {
...
const defaultClass = computed(() => {
    ...
    const classes = 'flex font-Nekst items-center transition-button duration-500 ease-linear gap-2.5'
